    ...
    <%        String id = "", name = "", dis = "", longi = "", lati = "";
        ...
        if (request.getParameter("btn_save") != null) {
            ...
            if (request.getParameter("hid").equals("")) {
                String insQry = "insert into tbl_location(district_id,location_name,location_longitude,location_latitude)values('" + request.getParameter("sel_district") + "','" + request.getParameter("txt_location") + "','" + request.getParameter("txt_longitude") + "','" + request.getParameter("txt_latitude") + "')";
                ...
                String upQry = "update tbl_location set district_id='" + request.getParameter("sel_district") + "',location_name='" + request.getParameter("txt_location") + "',location_longitude='" + request.getParameter("txt_longitude") + "',location_latitude='" + request.getParameter("txt_latitude") + "' where location_id='" + request.getParameter("hid") + "'";
                                        ...
                                        <tbody>
                                            ...
                                            <tr>    
                                                ...
                                                <td align="center"> 
                                                    ...
                                                    <a class="status_btn" href="Location.jsp?edit=<%=rs.getString("location_id")%>&name=<%=rs.getString("location_name")%>&id=<%=rs.getString("district_id")%>&longi=<%=rs.getString("location_longitude")%>&lati=<%=rs.getString("location_latitude")%>">Edit</a>
                                                </td> 
                                            </tr>
                                            <%                      }
